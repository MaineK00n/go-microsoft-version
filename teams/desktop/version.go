...
// Version represents a Microsoft Teams Desktop version (e.g., "25122.1415.3698.6812", "1.6.00.18681")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected Microsoft Teams Desktop version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
