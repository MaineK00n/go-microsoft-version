...
// Version represents a Microsoft Teams for Android version (e.g., "1.0.0.2024022302", "1.0.0.2025042801")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected Microsoft Teams for Android version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
