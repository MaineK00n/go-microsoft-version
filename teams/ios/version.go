...
// Version represents a Microsoft Teams for iOS version (e.g., "2.5.0", "7.10.1")
type Version struct {
	Major int
	Minor int
	Patch int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 3 {
		return Version{}, fmt.Errorf("unexpected Microsoft Teams for iOS version format. expected: %q, actual: %q", "<major>.<minor>.<patch>", ver)
	}
