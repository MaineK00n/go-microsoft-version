...
// Version represents a Microsoft Teams for Mac version (e.g., "1.6.00.17554", "24295.606.3252.8961")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected Teams for Mac version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
