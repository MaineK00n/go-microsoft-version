...
// Version represents a Microsoft Office version for Windows (e.g., "16.0.5474.1001", "15.0.5571.1000")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected Office version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
