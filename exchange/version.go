...
// Version represents a Microsoft Exchange Server version (e.g., "15.01.2375.012", "15.02.1118.040")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected Microsoft Exchange Server version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
