...
// Version represents a Microsoft SharePoint Server version (e.g., "16.0.5161.1000", "15.0.5353.1000")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected SharePoint version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
