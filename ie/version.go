...
// Version represents a Microsoft Internet Explorer version (e.g., "11.0.9600.21117", "9.0.8112.21631")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected Internet Explorer version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
