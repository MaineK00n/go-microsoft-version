...
// Version represents a Microsoft Defender Security Intelligence version (e.g., "1.379.200.0", "1.411.234.0")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected Defender Security Intelligence version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
