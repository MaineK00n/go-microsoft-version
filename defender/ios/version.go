...
// Version represents a Microsoft Defender for iOS version (e.g., "1.1.18090109", "1.1.57210105")
type Version struct {
	Major int
	Minor int
	Patch int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 3 {
		return Version{}, fmt.Errorf("unexpected Defender for iOS version format. expected: %q, actual: %q", "<major>.<minor>.<patch>", ver)
	}
