...
// Version represents a Microsoft Defender for Windows version (e.g., "4.18.23100.2009", "4.18.24070.5")
type Version struct {
	Major    int
	Minor    int
	Build    int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 4 {
		return Version{}, fmt.Errorf("unexpected Microsoft Defender for Windows version format. expected: %q, actual: %q", "<major>.<minor>.<build>.<revision>", ver)
	}
