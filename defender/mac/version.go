...
// Version represents a Microsoft Defender for Mac version (e.g., "101.60.91", "101.24082.0006")
type Version struct {
	Major int
	Minor int
	Patch int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 3 {
		return Version{}, fmt.Errorf("unexpected Microsoft Defender for Mac version format. expected: %q, actual: %q", "<major>.<minor>.<patch>", ver)
	}
