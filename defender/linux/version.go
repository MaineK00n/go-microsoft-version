...
// Version represents a Microsoft Defender for Linux version (e.g., "101.24052.0002", "101.98.84")
type Version struct {
	Major int
	Minor int
	Patch int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 3 {
		return Version{}, fmt.Errorf("unexpected Microsoft Defender for Linux version format. expected: %q, actual: %q", "<major>.<minor>.<patch>", ver)
	}
