...
// Version represents a Microsoft Defender for IoT version (e.g., "10.5.2", "22.2.6")
type Version struct {
	Major int
	Minor int
	Patch int
...
func NewVersion(ver string) (Version, error) {
	...
	if len(ss) != 3 {
		return Version{}, fmt.Errorf("unexpected Defender for IoT version format. expected: %q, actual: %q", "<major>.<minor>.<patch>", ver)
	}
